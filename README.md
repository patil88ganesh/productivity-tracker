...
## Downloads — version 2.8.1

- **Windows 10/11 x64:** [ProductivityTracker-Setup.exe](https://github.com/patil88ganesh/productivity-tracker/releases/download/v2.8.1/ProductivityTracker-Setup.exe)
- **macOS 12+ Apple silicon:** [ProductivityTracker-macOS-arm64.app.zip](https://github.com/patil88ganesh/productivity-tracker/releases/download/v2.8.1/ProductivityTracker-macOS-arm64.app.zip)
- **macOS 12+ Intel:** [ProductivityTracker-macOS-x64.app.zip](https://github.com/patil88ganesh/productivity-tracker/releases/download/v2.8.1/ProductivityTracker-macOS-x64.app.zip)

Release downloads will be published under:

`https://github.com/patil88ganesh/productivity-tracker/releases/tag/v2.8.1`
